...
public class PropertyController {
    ...
    public ResponseEntity<PropertyDTO> saveProperty(@RequestBody
    ...
    public ResponseEntity<List<PropertyDTO>> getAllProperties(){
       ...
       List<PropertyDTO> proprtiesList = propertyService.getAllProperties();
       ResponseEntity<List<PropertyDTO>> responseEntity = new ResponseEntity<>(proprtiesList, HttpStatus.OK);
       return responseEntity;
    }
